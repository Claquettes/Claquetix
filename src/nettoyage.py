fichier_mots = open("words/ref_text/french01.txt", "r")
...
fichier_mots.close()
fichier_mots = open("words/ref_text/french1K.txt", "r")
...
fichier_mots.close()
fichier_mots = open("words/ref_text/french2K.txt", "r")
for mot2 in fichier_mots.read().split(','):
        ok=True
        for mot_pris in liste_mots:
            if mot2 == mot_pris:
        ...
        if (ok) : liste_mots.append(mot2)
fichier_mots.close()
fichier_mots = open("words/ref_text/french10K.txt", "r")
for mot2 in fichier_mots.read().split(','):
        ok=True
        for mot_pris in liste_mots:
            if mot2 == mot_pris:
...
fichier_rslt = open("words/ref_text/words2test.txt", "w")
